  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-1 text-sm text-slate-600">
        Memproses pesanan (Sedang Dikemas &rarr; Menunggu Pengirim) tersedia di Level 4.
      </p>

      <div className="mt-4 space-y-3">
        {orders.length === 0 && <p className="text-sm text-slate-500">Belum ada pesanan masuk.</p>}
        {orders.map((o) => (
          <Link key={o.id} href={`/dashboard/seller/orders/${o.id}`}>
