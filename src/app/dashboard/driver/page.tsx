  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <Card>
          <h3 className="text-sm text-slate-500">Cari Job</h3>
          <p className="mt-1 text-sm text-slate-600">Belum tersedia (Level 5)</p>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <p className="mt-1 text-xl font-bold text-emerald-700">
            {user.driverProfile ? `Rp${user.driverProfile.totalEarning.toLocaleString("id-ID")}` : "—"}
          </p>
        </Card>
      </div>
    </div>
